<!-- source: https://docs.x402.org/advanced-concepts/wallet-compatibility.md -->
<!-- fetched: 2026-09-15 -->
...
> Which wallet types work with which x402 schemes, and why, based on how signatures are verified on-chain.
