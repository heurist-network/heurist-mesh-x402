<!-- source: https://docs.x402.org/extensions/eip2612-gas-sponsoring.md -->
<!-- fetched: 2026-09-15 -->
...
> Gasless Permit2 approval for ERC-20 tokens that implement EIP-2612. The facilitator submits the permit onchain, so the client never pays gas for the approval step.
